...
'''
This bot is developed by ABTMS TEAM, it is the first version deployed for public scraping,
...
-Secret keys: 
	-TOKEN: 1975993817:AAHkauIhhwRyf6slla4ya_6GUo58O0of85g
	- MODE: prod
	- CHAT_ID_FORWARD: -1001610323514
	- HEROKU_APP_NAME: qio01
'''
...
developers = ['1402716597']


addusr = ""
tk = os.getenv("1975993817:AAHkauIhhwRyf6slla4ya_6GUo58O0of85g")
mode = os.getenv("prod")

posting_channel = os.getenv("-1001610323514")
...
if mode == "dev":
	...
	def run(updater):
		...
		HEROKU_APP_NAME = os.environ.get("qio01")
...
@run_async
def start(update):
	update.message.reply_text("This CC Scraper has been started successfully | Developed by ABTMS TEAM")
